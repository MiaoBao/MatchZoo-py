...
- Remove SEP token, and remove CLS token similarity in the matrix
"""
import typing
...
class BertKNRMex(BaseModel):
    ...
    def forward(self, inputs):
        ...
        #document token weight = sim(query_CLS, doc_token)
        KM = []
        for kernel in self.kernels:
            # shape = [B, L]
            K_q = torch.log1p(kernel(matching_matrix[:,1:,1:]).sum(dim=-1)) #add weight here in the future
            KM.append(K_q)
...
'''
[Iter-64 Loss-0.695]:
  Validation: normalized_discounted_cumulative_gain@3(0.0): 0.2949 - normalized_discounted_cumulative_gain@5(0.0): 0.3914 - mean_average_precision(0.0): 0.342

[Iter-128 Loss-0.693]:
  Validation: normalized_discounted_cumulative_gain@3(0.0): 0.3391 - normalized_discounted_cumulative_gain@5(0.0): 0.4222 - mean_average_precision(0.0): 0.3882
  
  [Iter-192 Loss-0.686]:
  Validation: normalized_discounted_cumulative_gain@3(0.0): 0.6061 - normalized_discounted_cumulative_gain@5(0.0): 0.6478 - mean_average_precision(0.0): 0.6245
  
  [Iter-256 Loss-0.678]:
  Validation: normalized_discounted_cumulative_gain@3(0.0): 0.6387 - normalized_discounted_cumulative_gain@5(0.0): 0.6858 - mean_average_precision(0.0): 0.65
  [Iter-384 Loss-0.666]:
  Validation: normalized_discounted_cumulative_gain@3(0.0): 0.6076 - normalized_discounted_cumulative_gain@5(0.0): 0.6584 - mean_average_precision(0.0): 0.5969
